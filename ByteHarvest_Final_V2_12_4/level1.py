...
class Level:
    def __init__(self, farm_screen):
        ...
        self.default_position = pygame.math.Vector2(1280, 720)
    ...
    def add_map_boundaries(self, tmx_data):
        ...
        for x, y, width, height in walls:
            ...
            collision_sprite.rect = pygame.Rect(x, y, width, height)
    ...
    def tree_collision(self):
        ...
        for tree in self.tree_sprites.sprites():
            if tree.rect.colliderect(self.player.hitbox) and self.player.selected_tool == 'axe':
                tree.damage()
